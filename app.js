...
const translations = {
    en: {
        ...
        "about-p1": "I am a software engineer based in Pyeongtaek, South Korea, specializing in building modern web applications. With experience working in multicultural environments, I have developed a strong communication mindset and an adaptable approach to technology.",
        ...
        "about-value-education": "A.A. in Liberal Arts - Behavioral Sciences, Autodidactic Software Engineer",
        "about-label-languages": "Languages",
        "about-value-languages": "English (Native), Korean (Basic - Conversational and Technical Proficiency)",
        ...
        "project1-desc-1": "Architected a full-stack, dynamic job board application featuring user authentication, job posting workflows, and a responsive search interface.",
        "project1-desc-2": "Built dynamic filtering components with React and Express to handle complex queries across thousands of mock job listings.",
        "project1-desc-3": "Optimized backend REST API endpoints to reduce data payload sizes and improve client-side rendering speed.",
        "project2-title": "Community Chat: Real-Time Chat App (MERN & Socket.io)",
        "project2-desc-1": "Developed a scalable, real-time messaging application supporting instant user interaction, room creation, and photo-sharing capabilities.",
        "project2-desc-2": "Implemented event-driven architecture using Socket.io to manage persistent, low-latency bidirectional communication.",
        "project2-desc-3": "Integrated image uploading and optimized state updates to ensure smooth rendering.",
        ...
        "contact-value-location": "Pyeongtaek, South Korea (Available for Relocation)",
    ...
    ko: {
        ...
        "about-value-languages": "영어 (모국어 수준), 한국어 (기본 - 회화 및 기술 커뮤니케이션 가능)",
        "about-label-interests": "주요 전문 역량",
        "about-value-interests": "SPA 아키텍처, RESTful API 설계, MERN 스택, 성능 분석 및 튜닝",
        ...
        "project1-desc-1": "사용자 인증, 채용공고 등록 흐름, 반응형 검색 인터페이스를 갖춘 풀스택 채용 정보 플랫폼을 설계했습니다.",
        "project1-desc-2": "React와 Express로 동적 필터링 컴포넌트를 구현해 수천 건의 목업 채용공고를 효율적으로 탐색할 수 있게 만들었습니다.",
        "project1-desc-3": "백엔드 REST API 엔드포인트를 최적화해 데이터 페이로드를 줄이고 클라이언트 렌더링 속도를 개선했습니다.",
        "project2-title": "커뮤니티 채팅: 실시간 채팅 앱 (MERN & Socket.io)",
        "project2-desc-1": "실시간 메시지 송수신, 채팅방 생성, 사진 공유 기능을 지원하는 확장 가능한 실시간 채팅 애플리케이션을 개발했습니다.",
        "project2-desc-2": "Socket.io 기반 이벤트 드리븐 아키텍처를 구현해 지속적이고 저지연의 양방향 통신을 관리했습니다.",
        "project2-desc-3": "이미지 업로드를 통합하고 상태 업데이트를 최적화해 원활한 렌더링 경험을 제공했습니다.",
